...
/obj/item/clothing/mask/ncr_facewrap_winter
	name = "winter facewrap"
	desc = "A facewrap commonly employed by NCR troops in winter environments."
	icon_state = "ncr_facewrap_w"
	w_class = WEIGHT_CLASS_TINY
	flags_inv = HIDEFACE
	flags_cover = MASKCOVERSMOUTH
	visor_flags_cover = MASKCOVERSMOUTH
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	actions_types = list(/datum/action/item_action/adjust)
/obj/item/clothing/mask/ncr_facewrap_winter/attack_self(mob/user)
	adjustmask(user)
